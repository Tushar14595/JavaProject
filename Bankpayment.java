...
public class Bankpayment extends JFrame implements ActionListener
{
	  ...
	  public Bankpayment()
	{
		...
		t2.setBounds(680,250,150,30);
		t1.setBounds(680,300,150,30);
		t3.setBounds(680,350,150,30);
		t4.setBounds(680,400,150,30);
...
Font f1=new Font("Comic Sans MS",Font.ITALIC,14);
		t1.setFont(f1);
		t2.setFont(f1);
		t3.setFont(f1);
		t4.setFont(f1);
			...
			if(B==b1)
									 {
										...
										Connection cn=DriverManager.getConnection("jdbc:odbc:Stationary");
										  ...
										  int x=0;
                                         String sql3="insert into Bank_Receipt values('" + t1.getText() + "',"  + t2.getText() + "," + x +"," + t3.getText() + "," + balance + ",'" + t4.getText() + "')"; 
