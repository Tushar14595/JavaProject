...
public class Searchproduct extends JFrame implements ItemListener,ActionListener
{
  ...
  public Searchproduct()
    {
		...
		l6=new JLabel("Product Search Record");
		l7=new JLabel("Supplier_name");
		cg=new CheckboxGroup();
	...
	public void itemStateChanged(ItemEvent e)
		{
			...
			if(x==true) 
			{
				try
				{
					...
					String sql="Select P_ID from Product_Details";
				...
				if(y==true)
				{
					...
					String sql1="Select P_name from Product_Details";
			  ...
			  if(B==b1)
			  {
				  if(x==true)
				  {
					  try
					  {
						  ...
						  String sql2="Select * from Product_Details where P_ID="+n;
					 ...
					 try
					  {
						 ...
						 // int n=Integer.parseInt(str);
						  ...
						  String sql3="Select * from Product_Details where P_name='"+str+"'";
				...
				//  JButton B=(JButton)eb.getSource();
				  ...
				  if(B==b3)
				  {
					  try
					  {
						  ...
						  String sql4="Delete from Product_Details where P_ID="+n;
					  ...
					  catch(Exception e6)
					  {
                        ...
                        if(B==b2)
						{
							...
							try
							{
								...
								Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
						        Connection cn4=DriverManager.getConnection("jdbc:odbc:Stationary");
						        String sql4="Update Product_Details set P_TYPE=?,P_name=?,price=?,Quantity=?,Supplier_name=? where P_ID=?";
