...
public class C_creditLimit extends JFrame implements ActionListener
{
	JLabel l1,l2,l3,l4;
	JComboBox c1;
    JLabel lI;
	...
	public C_creditLimit()
	{
		...
		b2=new JButton("Back");
		l3=new JLabel("Customer Credit Limit");
		...
		JButton b=(JButton)e.getSource();
			if(b1==b)
			{
				...
				try
				{
					...
					String sql1="select Credit_Limit from Customer_Info where Cust_Name='"+str+"'";
