...
import java.sql.*;
public class SearchPurchaseBill extends JFrame implements ActionListener
{
	 int c;
	String d[][]=new String [100][6];
	String h[]={"PID","BillNo","Bill_Amnt","Paid_amnt","Bal","SName"};
	JButton B1,B2;
    JLabel lI;
	ImageIcon img;
	public SearchPurchaseBill()
	{
        setLayout(null);
	...
	try
	{
		...
		String sql="select * from Purchase_Bill where P_ID=" + n;
