...
public class SerachCustomer extends JFrame implements ItemListener,ActionListener
{
	...
	public void itemStateChanged(ItemEvent e)
		{
			...
			if(x==true) 
			{
				try
				{
					...
					String sql="Select Cust_ID from Customer_Info";
				...
				if(y==true)
				{
					...
					String sql1="Select Cust_Name from Customer_Info";
			  ...
			  if(B==b1)
			  {
				  if(x==true)
				  {
					  try
					  {
						  ...
						  String sql2="Select * from Customer_Info where Cust_ID="+n;
					 ...
					 try
					  {
						 ...
						 // int n=Integer.parseInt(str);
						  ...
						  String sql3="Select * from Customer_Info where Cust_Name='"+str+"'";
				...
				//  JButton B=(JButton)eb.getSource();
				  ...
				  if(B==b3)
				  {
					  try
					  {
						  ...
						  String sql4="Delete from Customer_Info where Cust_ID="+n;
					  ...
					  catch(Exception e6)
					  {
                        ...
                        if(B==b2)
						{
							...
							try
							{
								...
								Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
						        Connection cn4=DriverManager.getConnection("jdbc:odbc:Stationary");
						        String sql4="Update Customer_Info set Cust_Name=? ,Cust_Address=?,Con_No=?,Email_ID=?,Credit_Limit=? where Cust_ID=?";
