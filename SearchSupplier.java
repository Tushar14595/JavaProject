...
public class SearchSupplier extends JFrame implements ItemListener,ActionListener
{
  ...
  public SearchSupplier()
    {
		...
		l6=new JLabel("Supplier Search Record");
	...
	public void itemStateChanged(ItemEvent e)
		{
			...
			if(x==true) 
			{
				try
				{
					...
					String sql="Select S_ID from SupplierInfo";
				...
				if(y==true)
				{
					...
					String sql1="Select S_name from SupplierInfo";
			  ...
			  if(B==b1)
			  {
				  if(x==true)
				  {
					  try
					  {
						  ...
						  String sql2="Select * from SupplierInfo where S_ID="+n;
					 ...
					 try
					  {
						 ...
						 // int n=Integer.parseInt(str);
						  ...
						  String sql3="Select * from SupplierInfo where S_name='"+str+"'";
				...
				//  JButton B=(JButton)eb.getSource();
				  ...
				  if(B==b3)
				  {
					  try
					  {
						  ...
						  String sql4="Delete from SupplierInfo where S_ID="+n;
					  ...
					  catch(Exception e6)
					  {
                        ...
                        if(B==b2)
						{
							...
							try
							{
								...
								Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
						        Connection cn4=DriverManager.getConnection("jdbc:odbc:Stationary");
						        String sql4="Update SupplierInfo set S_name=? ,S_Address=?,S_contact_No=?,S_Email_ID=?,S_Credit_LIMIT=? where S_ID=?";
