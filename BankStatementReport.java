...
public class BankStatementReport extends JFrame implements ActionListener
{
JTable obj;
JButton B1,B2;
public BankStatementReport()
{
 ...
 {											
  ...
  String str="Select * from Bank_Receipt";
