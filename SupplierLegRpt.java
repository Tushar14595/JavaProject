...
public class SupplierLegRpt extends JFrame implements ActionListener
{
JTable obj;
JButton B1;
JButton B2;
public SupplierLegRpt()
{
 setLayout(null);
 JLabel L1;
 B1=new JButton("Print");
 B2=new JButton("Back");
 L1=new JLabel("Supplier Ledger Report");
 ...
 {											
  ...
  String str="Select * from Supplier_Receipt";
  ...
  obj.getColumnModel().getColumn(1).setPreferredWidth(70);
  obj.getColumnModel().getColumn(2).setPreferredWidth(100);
  obj.getColumnModel().getColumn(3).setPreferredWidth(80);
  obj.getColumnModel().getColumn(4).setPreferredWidth(90);
